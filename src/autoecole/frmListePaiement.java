...
public class frmListePaiement extends javax.swing.JInternalFrame {
    ...
    private void jTableCandidatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableCandidatMouseClicked
       ...
       int a_modifier=Integer.parseInt(jTableCandidat.getValueAt(sa, 0).toString());
        try {
            ...
            //String a=typecontrat.getText();
           if (typecontrat.getText().equals("contractuelle"))
            {
            ...
            reste_candidat.setText(String.valueOf(reste_));
               ...
               montant_paiement.setText("");
                ...
                prixconduite.setVisible(false);
                 ...
                 montant_paiement.setText( String.valueOf(paiement.mantantàpayer(rsdbCandidat.getInt("id_candidat"))));
                 // montant_paiement.setText("");
                nbheurecode.setVisible(true);
                nbcode.setVisible(true);
                  prixheurecode.setVisible(true);
                  prixcode.setVisible(true);
                 nbheureconduit.setVisible(true);
                  nbconduite.setVisible(true);
                prixheureconduite.setVisible(true);
                prixconduite.setVisible(true);
               }
